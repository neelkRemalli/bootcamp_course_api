...
// Get all bootcamps public access rotue Get api/v1/bootcamps/

exports.getBootcampAll = asyncHandler(async (req, res, next) => {
  res.status(200).json(res.advancedResults);
});
// Get only one bootcamp public access route Get api/v1/bootcamps/:id
...
// post only one bootcamp private access route Get api/v1/bootcamps/
...
// update only one bootcamp private access route put api/v1/bootcamps/:id
...
// delete only one bootcamp private access route delete api/v1/bootcamps/:id
